...
-----------------------------
    ...
    DiagnosticWarn         = { fg = hue_6_2 },
    DiagnosticInfo     = { fg = hue_1 },
    DiagnosticHint            = { fg = mono_1 },
    DiagnosticVirtualTextError       = { fg = hue_5 },
    DiagnosticVirtualTextWarn     = { fg = hue_6_2 },
    DiagnosticVirtualTextInfo = { fg = hue_1 },
    DiagnosticVirtualTextHint        = { fg = mono_1 },
    DiagnosticUnderlineError         = { sp = hue_5, style = 'undercurl' },
    DiagnosticUnderlineWarn       = { sp = hue_6_2, style = 'undercurl' },
    DiagnosticUnderlineInfo   = { sp = hue_1, style = 'undercurl' },
    DiagnosticUnderlineHint          = { sp = mono_1, style = 'undercurl' },
    DiagnosticFloatingError          = { fg = hue_5 },
    DiagnosticFloatingWarn        = { fg = hue_6_2 },
    DiagnosticFloatingInfo    = { fg = hue_1 },
    DiagnosticFloatingHint           = { fg = mono_1 },
    DiagnosticSignError              = { fg = hue_5 },
    DiagnosticSignWarn            = { fg = hue_6_2 },
    DiagnosticSignInfo        = { fg = hue_1 },
