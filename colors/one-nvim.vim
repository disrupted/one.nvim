...
-----------------------------
    ...
    LspDiagnosticsUnderlineError         = { sp = hue_5, style = 'undercurl' },
    LspDiagnosticsUnderlineWarning       = { sp = hue_6_2, style = 'undercurl' },
    LspDiagnosticsUnderlineInformation   = { sp = hue_1, style = 'undercurl' },
    LspDiagnosticsUnderlineHint          = { sp = mono_1, style = 'undercurl' },
