...
local highlight_groups = {
    ...
    TabLine      = { fg = mono_4, bg = none},
    TabLineFill  = { fg = mono_4, bg = none},
    TabLineSel   = { fg = mono_2, bg = none, style = 'bold' },
...
-----------------------------
    ...
    DiagnosticError           = { fg = hue_5 },
    DiagnosticWarning         = { fg = hue_6_2 },
    DiagnosticInformation     = { fg = hue_1 },
    DiagnosticHint            = { fg = mono_1 },
    DiagnosticVirtualTextError       = { fg = hue_5 },
    DiagnosticVirtualTextWarning     = { fg = hue_6_2 },
    DiagnosticVirtualTextInformation = { fg = hue_1 },
    DiagnosticVirtualTextHint        = { fg = mono_1 },
    DiagnosticUnderlineError         = { sp = hue_5, style = 'undercurl' },
    DiagnosticUnderlineWarning       = { sp = hue_6_2, style = 'undercurl' },
    DiagnosticUnderlineInformation   = { sp = hue_1, style = 'undercurl' },
    DiagnosticUnderlineHint          = { sp = mono_1, style = 'undercurl' },
    DiagnosticFloatingError          = { fg = hue_5 },
    DiagnosticFloatingWarning        = { fg = hue_6_2 },
    DiagnosticFloatingInformation    = { fg = hue_1 },
    DiagnosticFloatingHint           = { fg = mono_1 },
    DiagnosticSignError              = { fg = hue_5 },
    DiagnosticSignWarning            = { fg = hue_6_2 },
    DiagnosticSignInformation        = { fg = hue_1 },
    DiagnosticSignHint               = { fg = mono_1 },
